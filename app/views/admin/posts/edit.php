    ...
    <div class="row">
         ...
         <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="card card-body bg-light mt-5">
                <form action="<?php echo URLROOT; ?>/admin/edit_post/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <!-- We are not handling category update in this simple version as per model logic, but UI is here -->
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" name="thumbnail" class="form-control">
                         <input type="hidden" name="existing_thumbnail" value="<?php echo $data['thumbnail']; ?>">
                         <?php if(!empty($data['thumbnail'])): ?>
                            <small>Current: <?php echo $data['thumbnail']; ?></small>
                         <?php endif; ?>
                    </div>
